...
from src.services.anime_comment.schemas import CreateAnimeCommentSchema, UpdateAnimeCommentSchema, CommentTreeResponse
...
anime_comment_router = APIRouter(tags=["Anime comment"], )
